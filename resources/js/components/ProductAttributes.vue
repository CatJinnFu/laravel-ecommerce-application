...
<script>
    export default {
        ...
        methods: {
            loadAttributes() {
                let _this = this;
                axios.get('/ecommerce-application/public/admin/products/attributes/load').then (function(response){
            ...
            loadProductAttributes(id) {
                let _this = this;
                axios.post('/ecommerce-application/public/admin/products/attributes', {
                    id: id
            ...
            selectAttribute(attribute) {
                ...
                axios.post('/ecommerce-application/public/admin/products/attributes/values', {
                    id: attribute.id
                }).then (function(response){
            ...
            addProductAttribute() {
                if (this.currentQty === null || this.currentPrice === null) {
                    ...
                    axios.post('/ecommerce-application/public/admin/products/attributes/add', {
                        data: data
                    }).then (function(response){
            ...
            deleteProductAttribute(pa) {
                ...
                this.$swal({
                    ...
                    if (willDelete) {
                        console.log(pa.id);
                        axios.post('/ecommerce-application/public/admin/products/attributes/delete', {
                            id: pa.id,
                        }).then (function(response){

    ...
    export default {
        ...
        methods: {
            loadValues() {
                ...
                let _this = this;
                axios.post('/ecommerce-application/public/admin/attributes/get-values', {
                    id: attributeId
            ...
            saveValue() {
                if (this.value === '') {
                    ...
                    let attributeId = this.attributeid;
                    let _this = this;
                    axios.post('/ecommerce-application/public/admin/attributes/add-values', {
                        id: attributeId,
                        value: _this.value,
                        price: _this.price,
                    }).then (function(response){
            ...
            updateValue() {
                if (this.value === '') {
                    ...
                    let attributeId = this.attributeid;
                    let _this = this;
                    axios.post('/ecommerce-application/public/admin/attributes/update-values', {
                        id: attributeId,
                        value: _this.value,
                        price: _this.price,
            ...
            deleteAttributeValue(value) {
                this.$swal({
                    ...
                    if (willDelete) {
                        ...
                        this.key = this.values.indexOf(value);
                        let _this = this;
                        axios.post('/ecommerce-application/public/admin/attributes/delete-values', {
                            id: _this.currentId
                        }).then (function(response){
